...
import com.example.anywheredoor.databinding.ActivityVerifyBinding
...
class VerifyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this,com.example.anywheredoor.R.layout.activity_verify)
